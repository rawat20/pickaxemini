      ...
      <div className="flex items-center gap-2 px-2 py-1 relative">
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 4px 15px rgba(99,102,241,0.5), 0 0 30px rgba(99,102,241,0.2), inset 0 1px 0 rgba(255,255,255,0.1)",
          }}
        >
          <Pickaxe
            className="h-5 w-5"
            style={{
              color: "#a5b4fc",
              filter:
                "drop-shadow(0 0 6px rgba(165,180,252,0.8)) drop-shadow(0 0 12px rgba(99,102,241,0.6))",
            }}
          />
        </div>
        ...
        <div className="relative">
          <span
            ...
            style={{
              background:
                "linear-gradient(135deg, #1a1a2e 0%, #4f46e5 50%, #7c3aed 100%)",
          ...
          <span
            ...
            style={{
              color: "#818cf8",
              filter:
                "drop-shadow(0 0 4px rgba(99,102,241,0.9)) drop-shadow(0 0 8px rgba(165,180,252,0.7))",
